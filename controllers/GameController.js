...
class GameController {
  constructor(apiRouter) {
    ...
    apiRouter.get(this.basePath + "/getResults/:gameId", this.getResults.bind(this));
...
console.log('this is the player id from the frontend ' +firstPlayerId )
    //searching for another player in the game
...
//checking if the second player is on the game 
    ...
    return new Promise((resolve, reject) => {
      GameSchema.findOne({
        ...
        if (err) {
          ...
          console.log('This player is not participating in the game');
          resolve(null);
        }
      });
    });
  ...
  getResults(req, res) {
    ...
    const path = 'GET ' + this.basePath + '/getResults';
    console.info(method, 'Access to', path);
    const gameId = req.params.gameId;
            ...
            UserSchema.findOne({
              ...
              if (err) {
                ...
                res.status(200).send({
                  ...
                  firstPlayerScore: game.firstPlayerScore, secondPlayerScore: game.secondPlayerScore
                });
              }
            });
          }
